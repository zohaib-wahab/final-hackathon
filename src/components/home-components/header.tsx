    ...
    <div className="overflow-x-hidden">
      ...
      <div className="bg-white shadow-md border-b-2 border-[#E5E5E5] relative z-40">
        <div className="container mx-auto flex items-center justify-between py-4">
          {/* Logo */}
          <Link href={"/"}>
            <div className="text-2xl font-bold text-[#252B42] hover:text-slate-600 ml-2 transition-transform duration-200 hover:scale-105 active:scale-95">
              Bandage
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6 text-[#23A6F0]">
            <button className="text-sm font-medium flex items-center gap-2 transition-transform duration-200 hover:scale-105 active:scale-95">
              Login/Register
            </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-md">
            ...
            <div className="flex flex-col gap-4 items-center py-4">
              <button className="text-sm font-medium flex items-center gap-2 text-[#23A6F0] transition-transform duration-200 hover:scale-105 active:scale-95">
                Login/Register
              </button>
              {/* Other Icons */}
